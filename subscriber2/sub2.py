"""
consumer_not_interesting_service.py
-----------------------------------
FastAPI service that consumes messages from Kafka topic "not_interesting" and stores them
in MongoDB collection "not_interesting_messages". Also provides an API to fetch stored messages.
...
Environment Variables:
    ...
    - KAFKA_TOPIC_NOT_INTERESTING: Topic name (default: "not_interesting")
    - GROUP_ID: Kafka consumer group id (default: "not-interesting-subscriber-group")
    - MONGO_URI: MongoDB connection string (default: "mongodb://localhost:27017")
    - MONGO_DB: MongoDB database name (default: "newsdb")

Run:
    uvicorn consumer_not_interesting_service:app --host 0.0.0.0 --port 8102
"""
...
TOPIC_KEY = "KAFKA_TOPIC_NOT_INTERESTING"
DEFAULT_TOPIC = "not_interesting"
COLLECTION_NAME = "not_interesting_messages"
...
def build_consumer() -> KafkaConsumer:
    """
    Create a Kafka consumer configured for the 'not_interesting' topic.

    Returns:
        A configured KafkaConsumer instance.
    """
    bootstrap = os.getenv("KAFKA_BOOTSTRAP", "localhost:9092").split(",")
    group_id = os.getenv("GROUP_ID", "not-interesting-subscriber-group")
...
def get_messages() -> List[Dict[str, Any]]:
    """
    Retrieve all stored messages for the 'not_interesting' subscriber.
